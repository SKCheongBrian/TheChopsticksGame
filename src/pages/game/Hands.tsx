...
function Hands() {
  ...
  function handleClick(num: number, side: string, opp: boolean) {
    ...
    if (numClicks === 1) {
      ...
      if (opp) {
        if (side === "L") {
          setOppL(newNumber + num > 4 ? 0 : newNumber + num);
        } else {
          setOppR(newNumber + num > 4 ? 0 : newNumber + num);
        }
      } else {
        if (side === "L") {
          setSelfL(newNumber + num > 4 ? 0 : newNumber + num);
        } else {
          setSelfR(newNumber + num > 4 ? 0 : newNumber + num);
        }
      }
    }
  ...
  function handleSplit() {
    ...
    // 3 0 -> 1 2
    else if ((num1 === 3 && num2 === 0) || (num1 === 0 && num2 === 3)) {
      setSelfL(1);
      setSelfR(2);
    }
    // 4 0 -> 2 2
    // 4 0 -> 1 3
    else if ((num1 == 4 && num2 === 0) || (num1 === 0 && num2 == 4)) {
